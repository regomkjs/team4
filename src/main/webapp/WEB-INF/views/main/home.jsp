				...
				<div id="demo" class="carousel slide banner-box"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="<c:url value="/library/book/list"/>"><img
								src="<c:url value="resources/img/오픈.jpg"/>" alt="1"
								class="d-block"></a>
						</div>
						<div class="carousel-item">
							<img src="<c:url value="resources/img/토론.jpg"/>" alt="2"
								class="d-block">
						</div>
						<div class="carousel-item">
							<img src="<c:url value="resources/img/이벤트.jpg"/>" alt="3"
								class="d-block">
						</div>
					</div>
								...
								<c:if test="${post.po_totalHeart >= 1}">
									<tr>
										<td style="text-align: left;" class="d-flex"><span
											style="max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
												<a class="aTag-home"
												href="<c:url value="/post/detail?ca=-1&num=${post.po_num}"/>">[${post.ca_name}]
													${post.po_title}</a>
										</span> <span style="color: #FA5858; font-weight: bold;" class="ms-1">${post.po_totalHeart}</span>
											<span class="ms-auto"> <fmt:parseDate
													value="${post.po_datetime}" pattern="yyyy-MM-dd HH:mm:ss"
													var="parsedDate" /> <fmt:formatDate value="${parsedDate}"
													pattern="yyyy-MM-dd" />
										</span></td>
