...
CREATE TABLE `report` (
  ...
  `rp_type` varchar(100) NOT NULL,
  `rp_target` varchar(100) NOT NULL,
  `rp_writer` varchar(100) NOT NULL,
  `rp_me_id` varchar(100) NOT NULL,
  PRIMARY KEY (`rp_num`),
